  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* icon har xil o‘lchamda chiqadi */}
          <BsThreeDotsVertical className="md:text-[18px] text-[22px]" />
        </Popover>
      </div>
      ...
      <div
        ...
        <div>
          <div className="flex items-center flex-wrap gap-2 font-[600]">
